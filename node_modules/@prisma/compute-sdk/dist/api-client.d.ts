...
export declare class InternalApiClient {
    ...
    promoteService(computeServiceId: string, body: PromoteServiceBody, signal?: AbortSignal): Promise<import("better-result").Err<{
        serviceEndpointDomain: string;
...
export type PromoteServiceBody = NonNullable<paths["/v1/compute-services/{computeServiceId}/promote"]["post"]["requestBody"]>["content"]["application/json"];
